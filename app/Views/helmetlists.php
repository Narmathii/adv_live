                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-6">
                                    <a href="<?php echo base_url() ?>details">
                                        <div class="de-item mb30">
                                            <div class="d-img">
                                            <img src="<?php echo base_url() ?>public/assets/images/gallery/helmet1.webp" />
                                            </div>
                                            <div class="d-info">
                                                <div class="d-text">
                                                    <h4>TROOPER DV D1 DECOR BLUE & PINK</h4>
                                                    <div class="d-price">
                                                        <span>₹ 1895.00</span>
                                                        <a class="btn-main" href="02_dark-car-single.html">Buy</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <a href="<?php echo base_url() ?>details">
                                        <div class="de-item mb30">
                                            <div class="d-img">
                                            <img src="<?php echo base_url() ?>public/assets/images/gallery/helmet2.webp" />
                                            </div>
                                            <div class="d-info">
                                                <div class="d-text">
                                                    <h4>THUNDER D9 DECOR MATT BLACK & RED</h4>
                                                    <div class="d-price">
                                                        <span>₹ 1985.00</span>
                                                        <a class="btn-main" href="02_dark-car-single.html">Buy</a>
                                                    </div>
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <a href="<?php echo base_url() ?>details">
                                        <div class="de-item mb30">
                                            <div class="d-img">
                                            <img src="<?php echo base_url() ?>public/assets/images/gallery/helmet3.webp" />
                                            </div>
                                            <div class="d-info">
                                                <div class="d-text">
                                                    <h4>DOWNTOWN WHITE</h4>
                                                    <div class="d-price">
                                                        <span>₹ 1895.00</span>
                                                        <a class="btn-main" href="02_dark-car-single.html">Buy</a>
                                                    </div>
                                ...
                                <!-- <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="<?php echo base_url() ?>public/assets/images/cars/jeep-renegade.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                                <h4>HIMALAYAN</h4>
