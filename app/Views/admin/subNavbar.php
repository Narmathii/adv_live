...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Sub Navbar</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="#">Masters</a></li>
                                <li class="breadcrumb-item"><a href="#">Navbar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sub Navbar</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add Sub Navbar</h5>
                ...
                <div class="modal-body">
                    <form id="subnav-form">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="nav_id" class="form-label">Navbar Title
                                </label><br>
                                <select class="form-select" name="nav_id" id="nav_id">
                                    <option value="">Select Navbar</option>
                                    <?php foreach ($navbar as $nav) {
                                        ?>
                                        <option value="<?php echo $nav['nav_id']; ?>">
                                             <?php echo $nav['nav_title']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                                <span class="error text-danger nav_id mt-5"></span>
                            </div>
                            <div class="my-2">
                                <label for="sub_navbar" class="form-label">Sub Navbar</label>
                                <input type="text" class="form-control sub_navbar" id="sub_navbar"
                                    placeholder="Sub Navbar" name="sub_navbar" value="">
                                <span class="error text-danger sub_navbar mt-10"></span>
                            </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/subNavbar.js"></script>
