...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Youtube Link</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Youtube Link</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add Youtube Link</h5>
                ...
                <div class="modal-body">
                    <form id="ytube-form">
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                <label for="ytube_link" class="form-label">Youtube Link</label>
                                <input type="text" class="form-control ytube_link" id="ytube_link"
                                    placeholder="Youtube Link" name="ytube_link" value="">
                                <span class="error text-danger ytube_link mt-10"></span>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="ytube_img" name="ytube_img">

                                <img src="" id="ytube_image_url" alt="image" width="130px"
                                    style="padding-top: 15px; display:none;">

                                <span class="error text-danger ytube_img mt-5"></span>
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/ytublink.js"></script>
