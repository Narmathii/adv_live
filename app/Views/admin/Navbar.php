...
<body>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Navbars</a></li>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add Navbar</h5>
                    ...
                    <form id="nav-form">
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                ...
                                <input type="text" class="form-control nav_title" id="nav_title"
                                    placeholder="Navbar Tilte" name="nav_title" value="">
                                <span class="error text-danger nav_title mt-10"></span>
                            </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/Navbar.js"></script>
