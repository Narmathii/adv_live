...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">State List</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="#">User Address</a></li>
    ...
    <div class="modal fade bs-example-modal-lg" id="state_modal" tabindex="-1" role="dialog"
        aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add State</h5>
                ...
                <div class="modal-body">
                    <form id="modal-form">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                <label for="state_title" class="form-label">State</label>
                                <input type="text" class="form-control state_title" id="state_title"
                                    placeholder="State Name" name="state_title" value="">
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/stateList.js"></script>
