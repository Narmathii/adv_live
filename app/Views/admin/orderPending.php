...
<div>
    ...
    <!-- LOADER -->
    <div id="loader">
        <img src="<?php echo base_url() ?>assets/admin/loader.svg" alt="">
    </div>
    <!-- END LOADER -->
...
<div class="modal fade bs-example-modal" id="cancel_order_modal" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="cancel_reason" id="cancel_reason"
                        rows="3"> User opened the payment page but did not complete payment.</textarea>
                </div>
                    ...
                    <table class="table text-nowrap">
                        <div class="table-responsive">
                            <select class="form-select" name="delivery_status" id="delivery_status"
                                ...
                                <?php
                                foreach ($delivery_sts as $status) {
