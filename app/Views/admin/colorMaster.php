...
<body>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add Colors</h5>
                ...
                <div class="modal-body">
                    <form id="modal-form">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="access_id" class="form-label">Color Name
                                </label><br>
                                <input type="text" class="form-control color_name" id="color_name"
                                    placeholder="Colors Name" name="color_name" value="">
                                <span class="error text-danger color_name mt-5"></span>
                            </div>
                            <div class="my-2">
                                <label for="hex_code" class="form-label">Hex Code</label>
                                <input type="text" class="form-control hex_code" id="hex_code" placeholder="Hex Code"
                                    name="hex_code" value="">
                                <span class="error text-danger hex_code mt-10"></span>
                            </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/colormaster.js"></script>
