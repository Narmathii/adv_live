...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">District</h1>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add District</h5>
                ...
                <div class="modal-body">
                    <form id="modal-form">
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                <label for="dist_name" class="form-label">District</label>
                                <input type="text" class="form-control dist_name" id="dist_name"
                                    placeholder="District Name" name="dist_name" value="">
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/district.js"></script>
