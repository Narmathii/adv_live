...
<body class="dark-scheme" id="products_page">
    <?php
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <?php for ($i = 0; $i < count($product); $i++) { ?>
                                <div class="col-6 col-lg-3 productCard">
                                    <a
                                        href="<?php echo base_url() ?>detail/<?php echo strtolower(str_replace(' ', '-', $product[$i]['redirect_url'])) ?>">
                                        <div class="de-item mb30">
                                            ...
                                            <div class="d-info">
                                                <div class="d-text">
                                                    ...
                                                    <div class="d-price">
                                                        ₹<span>
                                                            <?php $formate = number_format($product[$i]['product_price'], 2);
                                                            echo $formate ?>
                                                        </span>
                                                        <a class="btn-main"
                                                            href="<?php echo base_url() ?>detail/<?php echo strtolower(str_replace(' ', '-', $product[$i]['redirect_url'])) ?>">Buy</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
