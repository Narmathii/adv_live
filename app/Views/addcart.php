                    ...
                    <div class="row g-5">
                        <div class="col-lg-6">
                            <div id="slider-carousel" class="owl-carousel">
                                <div class="item">
                                    <img src="<?php echo base_url() ?>public/assets/images/car-single/1.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url() ?>public/assets/images/car-single/2.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url() ?>public/assets/images/car-single/3.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url() ?>public/assets/images/car-single/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
